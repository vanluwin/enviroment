...
sudo apt-get install -y build-essential cmake build-essential cmake git unzip pk    g-config libjpeg-dev libtiff5-dev libavcodec-dev libavformat-dev libswscale-dev     libv4l-dev libxvidcore-dev libx264-dev libgtk-3-dev libhdf5-serial-dev graphviz     libopenblas-dev libatlas-base-dev gfortran python-tk python3-tk python-imaging-t    k python2.7-dev python3-dev linux-image-generic linux-image-extra-virtual linux-    source linux-headers-generic unzip wget qt5-default
